...
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
//       // Refresh cases from backend to stay consistent
//       await fetchCases();
...
//   // Compute weekly trend from fetched cases
//   useEffect(() => {
//     if (allCases.length > 0) {
//       const newByDay = new Array(7).fill(0); // 0=Sun, 1=Mon, ..., 6=Sat
...
//       const newData = [
//         newByDay[1], newByDay[2], newByDay[3], newByDay[4],
//         newByDay[5], newByDay[6], newByDay[0]
//       ];
//       const resolvedData = [
//         resolvedByDay[1], resolvedByDay[2], resolvedByDay[3], resolvedByDay[4],
//         resolvedByDay[5], resolvedByDay[6], resolvedByDay[0]
//       ];
//       setTrendChartData({
//         labels: days,
//         datasets: [
...
//   // Chart data for status (from fetched cases)
...
//   // Chart data for priority (adjusted to high/low from fetched cases)
...
//   // Fixed domains for chart
//   const possibleDomains = ["E-commerce", "Travel", "Telecommunications", "Banking Services"];
//   const domainCounts = possibleDomains.map(domain => 
//     allCases.filter(c => c.domain === domain).length
//   );
...
//       {/* Statistics Cards - using fetched data */}
...
//       {/* Charts Section - using fetched data */}
...
//                   >
//                     <p>
//                       <strong>{r.adminId ? r.adminId.name : "User"}</strong> ({new Date(r.timestamp).toLocaleString()}):
//                       <br />
//                       {r.message}
//                     </p>
//                   </div>
