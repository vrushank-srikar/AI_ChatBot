...
//       // Only handle non-agent messages here to avoid duplicates
...
//       ) {
//         safeAppend(payload, "bot");
//       }
//     };

//     const onCaseMessage = (payload = {}) => {
//       if (!selectedCase) return;
//       // Only for the active case; agent messages come through here
...
//         // normalize responses to [] to avoid `.some` crash
...
//         // DO NOT emit join here (handled in join/leave effect)
//       } catch (e) {
...
//         setSelectedCase(response.data.case);
//       }
//       // No optimistic append here; we'll show the single echo from `case:message`
//       setResponseMessage("");
...
//       // getDay: 0=Sun .. 6=Sat → align to Mon..Sun
//       const newData = [
//         newByDay[1],
//         newByDay[2],
//         newByDay[3],
...
//   // helper: does this case already have any agent reply?
...
//                 onClick={() => {
//                   // leave is handled by effect cleanup
