...
// // Simple memory schema for cases
...
// // index or update a case into memory
...
//     );
//     console.log(`Indexed case memory for case ${caseDoc._id}`);
//   } catch (err) {
//     console.error("Case memory indexing error:", err?.message || err);
//   }
// }

// // search for similar cases by text (returns topK with score)
...
//     // small-scale approach: fetch candidates from DB and score in JS
//     const candidates = await CaseMemory.find(filter).lean().limit(200); // limit to reasonable number
